...
git submodule add https://github.com/plasticboy/vim-markdown.git pack/plugins/start/vim-markdown && \
git submodule add https://github.com/terryma/vim-multiple-cursors.git pack/plugins/start/vim-multiple-cursors && \
git submodule add https://github.com/tpope/vim-surround.git pack/plugins/start/vim-surround && \
git submodule add https://github.com/tpope/vim-dispatch.git pack/plugins/start/vim-dispatch && \
git submodule add https://github.com/junegunn/vader.vim.git pack/plugins/start/vader.vim && \
git submodule add https://github.com/reedes/vim-pencil pack/plugins/start/github && \
git submodule add https://github.com/bling/vim-airline.git pack/plugins/start/vim-airline && \
